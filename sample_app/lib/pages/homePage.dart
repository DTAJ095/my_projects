        ...
        child: Column(
          children: [
            ...
            Column(
              ...
              Text('Jaures Alban', style: GoogleFonts.alata(
            ...
            Padding(
              ...
              child: ListTile(
                title: Text('Home', style: GoogleFonts.alata(
                  textStyle: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)
                ),),
            ...
            Padding(
              ...
              child: ListTile(
                title: Text('Logout', style: GoogleFonts.alata(
                  textStyle: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)
                ),),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    Icon(MdiIcons.store, color: isPressed ? Colors.white : Colors.black),
                    Text('Shop', style: GoogleFonts.alata(
                      textStyle: isPressed ? const TextStyle(
                        color: Colors.white,
                        fontSize: 20,
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                  children: [
                    Icon(MdiIcons.cart, color: isPressed ? Colors.black : Colors.white),
                    Text('Cart', style: GoogleFonts.alata(
                      textStyle: isPressed ? const TextStyle(
                        color: Colors.black,
                        fontSize: 20,
